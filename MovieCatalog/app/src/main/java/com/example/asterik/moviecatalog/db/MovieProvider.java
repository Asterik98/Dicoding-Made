...
import static com.example.asterik.moviecatalog.db.DatabaseContract.AUTHORITY;
...
public class MovieProvider extends ContentProvider {
    ...
    public Uri insert(@NonNull Uri uri, ContentValues contentValues) {
        ...
        getContext().getContentResolver().notifyChange(CONTENT_URI, new MovieFragmentFav.DataObserver(new Handler(), getContext()));
